...
urlpatterns = [
    ...
    path("shift-templates/<int:template_id>/update", update_shift_template, name="update_shift_templates_by_team"),
    path("shift-templates/<int:template_id>/delete", delete_shift_template, name="delete_shift_templates_by_team"),
    ...
    path("shift-exceptions/<int:exception_id>/update", update_shift_exception, name="update_shift_exception"),
    path("shift-exceptions/<int:exception_id>/delete", delete_shift_exception, name="update_shift_exception"),
