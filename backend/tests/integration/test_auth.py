...
@pytest.mark.django_db
def test_protected_route_with_jwt(api_client, auth_headers, WHOAMI="/api/token/whoami/"):
...
@pytest.mark.django_db
def test_expired_token_is_rejected(api_client, expired_headers, WHOAMI="/api/token/whoami/"):
